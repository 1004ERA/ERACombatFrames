...
function ERACombatFrames_EvokerSetup_OLD(cFrame)
    ...
    if (devastationActive) then
        ERACombatFrames_EvokerDevastationSetup_OLD(cFrame, enemies, essence, combatHealth, talents)
    end
    if (preservationActive) then
        ERACombatFrames_EvokerPreservationSetup_OLD(cFrame, talents)
    end
    if (augmentationActive) then
        ERACombatFrames_EvokerAugmentationSetup_OLD(cFrame, enemies, essence, combatHealth, talents)
    end
end
