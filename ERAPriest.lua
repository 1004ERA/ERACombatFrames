...
function ERACombatFrames_PriestShadowSetup(cFrame, kyrian_talent)
    ...
    local insanity = ERACombatPower:Create(cFrame, -200, -32, 123, 22, 13, false, 0.5, 0.0, 1.0, 3)
    ...
    local devouringDisplay = timers:AddAuraBar(devouringTimer, nil, 0.1, 0.7, 0.3)
     --, talent_torrent)
    --[[
