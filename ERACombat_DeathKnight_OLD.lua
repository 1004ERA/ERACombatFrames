...
function ERACombatFrames_DeathKnightSetup_OLD(cFrame)
    ERADK_RuneSize = 24
    ERADK_BarsHeight = 36
    ...
    if (bloodActive) then
        ERACombatFrames_DeathKnightBloodSetup_OLD(cFrame, runes, talents)
    end
    if (frostActive) then
        ERACombatFrames_DeathKnightFrostSetup_OLD(cFrame, runes, talents)
    end
    if (unholyActive) then
        ERACombatFrames_DeathKnightUnholySetup_OLD(cFrame, runes, talents)
    end
end
